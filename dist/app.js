...
var _user$project$Main$isSublist = F2(
	function (subList, sourceList) {
		return A2(
			_elm_lang$core$List$filter,
			function (x) {
				return A2(_elm_lang$core$List$member, x, sourceList);
			},
			subList);
	});
var _user$project$Main$possibleMatches = {
	ctor: '::',
	_0: {
		ctor: '::',
		_0: 1,
...
var _user$project$Main$checkGameOver = F2(
	function (nextType, xnOList) {
		var filteredList = _elm_lang$core$List$sort(
			A2(
				_elm_lang$core$List$map,
				function (x) {
					return x.id;
				...
				A2(
					_elm_lang$core$List$filter,
					function (x) {
						return _elm_lang$core$Native_Utils.eq(x.value, nextType);
					},
					xnOList)));
		var isSubList = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(filteredList),
			3) > -1) ? A3(
			_elm_lang$core$List$foldl,
			F2(
				function (x, acc) {
					return _elm_lang$core$Native_Utils.eq(acc, true) ? true : A2(
						F2(
							function (x, y) {
						...
						_elm_lang$core$List$length(
							A2(_user$project$Main$isSublist, filteredList, x)));
				}),
			false,
			_user$project$Main$possibleMatches) : false;
		var isMember = isSubList ? true : false;
		return isMember;
	});
var _user$project$Main$typeToString = function (value) {
	var _p0 = value;
	switch (_p0.ctor) {
		case 'Cross':
			return 'X';
...
var _user$project$Main$spanClass = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'border-right', _1: '1px solid black'},
	_1: {
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'padding-left', _1: '30px'},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {nextType: a, currentList: b, overStatus: c, winner: d, winItems: e};
	});
var _user$project$Main$XnO = F2(
	function (a, b) {
		return {id: a, value: b};
	});
var _user$project$Main$None = {ctor: 'None'};
var _user$project$Main$getInititalList = {
	ctor: '::',
	_0: {id: 1, value: _user$project$Main$None},
	_1: {
		ctor: '::',
		_0: {id: 2, value: _user$project$Main$None},
		_1: {
			ctor: '::',
			_0: {id: 3, value: _user$project$Main$None},
			_1: {
				ctor: '::',
				_0: {id: 4, value: _user$project$Main$None},
				_1: {
					ctor: '::',
					_0: {id: 5, value: _user$project$Main$None},
					_1: {
						ctor: '::',
						_0: {id: 6, value: _user$project$Main$None},
						_1: {
							ctor: '::',
							_0: {id: 7, value: _user$project$Main$None},
							_1: {
								ctor: '::',
								_0: {id: 8, value: _user$project$Main$None},
								_1: {
									ctor: '::',
									_0: {id: 9, value: _user$project$Main$None},
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Main$renderBox = F3(
	function (overStatus, itemId, value) {
		var onClickMsg = function () {
			var _p1 = overStatus;
			if (_p1.ctor === 'Not') {
				return _user$project$Main$UpdateValue(itemId);
			} else {
				return _user$project$Main$NoOp;
			}
		}();
		var newValue = _user$project$Main$typeToString(value);
		return A2(
			_elm_lang$html$Html$td,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_user$project$Main$spanClass),
					_1: {
						ctor: '::',
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(newValue),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Main$createRow = F2(
	function (list, overStatus) {
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				function (x) {
					return A3(_user$project$Main$renderBox, overStatus, x.id, x.value);
				},
				list));
	});
var _user$project$Main$Not = {ctor: 'Not'};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		nextType: _user$project$Main$Cross,
		currentList: _user$project$Main$getInititalList,
		overStatus: _user$project$Main$Not,
		winner: '',
		winItems: {ctor: '[]'}
	},
	...
	function (msg, model) {
		...
		if (_p2.ctor === 'UpdateValue') {
			var newList = A2(
				_elm_lang$core$List$map,
				function (x) {
					return (_elm_lang$core$Native_Utils.eq(x.id, _p2._0) && _elm_lang$core$Native_Utils.eq(x.value, _user$project$Main$None)) ? _elm_lang$core$Native_Utils.update(
						x,
						{value: model.nextType}) : x;
				},
				model.currentList);
			var newType = (!_elm_lang$core$Native_Utils.eq(newList, model.currentList)) ? (_elm_lang$core$Native_Utils.eq(model.nextType, _user$project$Main$Cross) ? _user$project$Main$Zero : _user$project$Main$Cross) : model.nextType;
			var isWin = A2(_user$project$Main$checkGameOver, model.nextType, newList);
			var isGameOver = A2(
				F2(
					function (x, y) {
						return _elm_lang$core$Native_Utils.eq(x, y);
				...
				_elm_lang$core$List$length(
					A2(
						_elm_lang$core$List$filter,
						function (x) {
							return _elm_lang$core$Native_Utils.eq(x.value, _user$project$Main$None);
						},
						newList)));
			var _p3 = isWin ? {
				ctor: '_Tuple2',
				_0: _user$project$Main$typeToString(model.nextType),
				_1: _user$project$Main$Win
			} : (isGameOver ? {ctor: '_Tuple2', _0: '', _1: _user$project$Main$Draw} : {ctor: '_Tuple2', _0: '', _1: _user$project$Main$Not});
			var newWinner = _p3._0;
			var newoverStatus = _p3._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{nextType: newType, currentList: newList, overStatus: newoverStatus, winner: newWinner}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			return A2(
...
var _user$project$Main$view = function (model) {
	var overStatusText = _elm_lang$core$Native_Utils.eq(model.overStatus, _user$project$Main$Win) ? A2(_elm_lang$core$Basics_ops['++'], 'Winner is ', model.winner) : (_elm_lang$core$Native_Utils.eq(model.overStatus, _user$project$Main$Draw) ? 'Draw' : '');
	var thirdRow = _elm_lang$core$List$reverse(
		A2(
			_elm_lang$core$List$take,
			3,
			_elm_lang$core$List$reverse(model.currentList)));
	var secondRow = A2(
		_elm_lang$core$List$filter,
		function (x) {
			return (_elm_lang$core$Native_Utils.cmp(x.id, 3) > 0) && (_elm_lang$core$Native_Utils.cmp(x.id, 7) < 0);
		},
		model.currentList);
	var firstRow = A2(_elm_lang$core$List$take, 3, model.currentList);
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$Main$createRow, firstRow, model.overStatus),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$createRow, secondRow, model.overStatus),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$createRow, thirdRow, model.overStatus),
							_1: {ctor: '[]'}
						}
					}
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(overStatusText),
				_1: {ctor: '[]'}
			}
		});
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"tags":{"NoOp":[],"UpdateValue":["Int"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
